...
export function AdminSidebar() {
  ...
  return (
    <>
      ...
      <aside className="hidden w-60 shrink-0 flex-col bg-gradient-to-b from-[#0f2d5c] to-[#17406f] text-white xl:w-72 lg:flex">
          ...
          {adminSidebarLinks.map((item) => {
            ...
            return (
              <Link
                key={item.key}
                href={item.href}
                className={`group flex items-center gap-3 rounded-xl py-2.5 ps-3 transition-all duration-200 xl:px-4 xl:py-3 ${
                  isActive

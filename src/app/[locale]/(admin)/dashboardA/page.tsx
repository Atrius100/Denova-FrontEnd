...
export default function AdminDashboard() {
    ...
    const statsItems = [
        ...
        {
            title:
                t("universityPatients"),

            description:
                t("universityPatientsDesc"),

            value:
                data.universityPatients,
    ...
    return (
        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <h1
                    className="
            text-2xl font-bold text-[#1e3a6d]
            md:text-3xl
          "
                >
                ...
                "
                  ...
                  "
                    ...
                    "
                                ...
                                <h2
                                    className="
                    font-bold text-[#1e3a6d]
                  "
                                >

                                    {
                                        t(
                                            `links.${item.key}.title`
                                        )
                                    }
                                </h2>

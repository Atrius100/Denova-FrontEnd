...
export function PasswordField({ id, label, compact = false, className = "", ...props }: PasswordFieldProps) {
  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="relative">
        <Lock aria-hidden="true" className="pointer-events-none absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-slate-500" />
        <input
          id={id}
